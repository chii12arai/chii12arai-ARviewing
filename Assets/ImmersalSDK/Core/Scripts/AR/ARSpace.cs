...
namespace Immersal.AR
{
    ...
    public class ARSpace : MonoBehaviour
    {
		...
		public static ARMap LoadAndInstantiateARMap(Transform root, SDKMapResult map, ARMap.RenderMode renderMode = ARMap.RenderMode.DoNotRender, Color pointCloudColor = default, bool applyAlignment = false)
		{
            ...
            arMap.LoadMap(map.mapData, map.metadata.id);
            return arMap;
		}
		...
		public static async Task<ARMap> LoadAndInstantiateARMap(Transform root, SDKJob map, byte[] mapData = null, ARMap.RenderMode renderMode = ARMap.RenderMode.DoNotRender, Color pointCloudColor = default, bool applyAlignment = false)
		{
            ...
            j.id = map.id;
            j.token = map.privacy == 0 ? ImmersalSDK.Instance.developerToken : "";
